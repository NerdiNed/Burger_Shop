...
function sendEmail(name, email, subject, message, callback) { 
 ...
 //!2+3 so in from: we also enter the email created for the site info@gmail because that is the email address the admin gets the notification from 
//! 4 here we enter the email we want to receive the notification from for example neda@gmail there i will get a notification from info@gmail that i have received an email from the customer that has written a message to info@gmailcom on the website

//! in the contact.js i changed the path of the URL

//! in the css- bootstrap.min.css i changed the modal. z-index into 9999999 
//! as i had a bug in the bootstrap version 4. the modal window was not closing. 
